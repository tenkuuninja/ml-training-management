...
const AdminHeader = ({ toggleMenu }: any) => {
  ...
  return (
    <header className="flex h-[72px] items-center justify-between border-b border-neutral-100 bg-white px-6 py-2">
      <AiOutlineMenu
        ...
        onClick={toggleMenu}
      />
      <img className="hidden max-h-[50px] lg:block" src="/assets/large-logo.png" alt="" />
      <img className="max-h-[50px] lg:hidden" src="/assets/logo.png" alt="" />
      <div
